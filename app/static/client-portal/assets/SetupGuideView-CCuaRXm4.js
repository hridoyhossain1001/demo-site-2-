...
analytics.subscribe("checkout_started", (event) => {
  ...
  fetch(API_URL + "?key=" + API_KEY, {
    ...
    (window,document,'script','${p}/t.js?key=${u||"YOUR_PUBLIC_TRACKER_KEY"}');
  <\/script>`,f=`// 1. Identify User (before firing events, e.g. on checkout, login, or registration)
capi('setUser', {
