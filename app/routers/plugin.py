...
def _plugin_update_response(download_url: str, package_sha256: str, signature: str) -> JSONResponse:
    return JSONResponse(content={
        ...
        "changelog": (
            "<h4>v1.2.54</h4><ul>"
            "<li>Blocks disabled storefront events at the browser tracker and WordPress tracking endpoints so optional events stay off when toggled off</li>"
            "</ul>"
            "<h4>v1.2.53</h4><ul>"
            "<li>Syncs the dedicated CAPI signing secret during the WordPress plugin health check so stores can recover without reconnecting</li>"
            "</ul>"
            "<h4>v1.2.52</h4><ul>"
            "<li>Refreshes the plugin package so connected stores can receive the dedicated CAPI signing-secret update</li>"
            "</ul>"
            "<h4>v1.2.51</h4><ul>"
